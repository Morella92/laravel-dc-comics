...
class ComicsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        foreach ($comics as $comic) {
            $comic_book = new Comic();

            $comic_book->title = $comic['title'];
            $comic_book->description = $comic['description'];
            $comic_book->thumb = $comic['thumb'];
            $comic_book->price = $comic['price'];
            $comic_book->series = $comic['series'];
            $comic_book->sale_date = $comic['sale_date'];
            $comic_book->type = $comic['type'];
